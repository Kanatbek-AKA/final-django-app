...
# Examsgrades to link with foreign key or add a colum examgrades above in class lessons or learner    
class examGrades(models.Model):
   id = models.AutoField(primary_key=True)
   course = models.ForeignKey(Course, on_delete=models.CASCADE)
#    learner = models.ForeignKey(Learner, on_delete=models.CASCADE)
#    lesson = models.ForeignKey(Lesson, on_delete=models.CASCADE)
   exam_question = models.ManyToManyField(Question)
   exam_answer = models.ManyToManyField(Choice)
